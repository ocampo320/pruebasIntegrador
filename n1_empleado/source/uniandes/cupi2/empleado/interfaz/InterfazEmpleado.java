...
<<<<<<< HEAD
    ...
    public void reqFuncOpcion2( )
    {
        ...
        JOptionPane.showMessageDialog( this, respuesta, "Respuesta", JOptionPane.INFORMATION_MESSAGE );
=======
        double respuesta = empleado.metodo1( );
        actualizar( );
      double salario= empleado.getSalario();
      double antiguedad=empleado.calcularAntiguedad();
      double calculoSalario=0;
      double nuevoSalario=0;
      if(antiguedad==1) {
    	  calculoSalario = salario*0.15;
    	  nuevoSalario=calculoSalario+salario;
    	  
    	  JOptionPane.showMessageDialog(this, "El salario teniendo en cuenta la antiguedad del empleado es: "+ nuevoSalario);
      }
      
      if(antiguedad>1&&antiguedad<=2) {
    	  
    	  calculoSalario = salario*0.18;
    	  nuevoSalario=calculoSalario+salario;
    	  JOptionPane.showMessageDialog(this, "El salario teniendo en cuenta la antiguedad del empleado es: "+ nuevoSalario);
...
if(antiguedad>2&&antiguedad<=3) {
    ...
    public void reqFuncOpcion2( )
    {
        int respuesta = empleado.metodo2( );
        actualizar( );
        double salario=empleado.getSalario();
        double nuevoSalario=0;
        double prima=0;
        
        if(respuesta<2016&& empleado.calcularEdad()<28) {
        	nuevoSalario=salario*0.10;
        	prima=nuevoSalario+salario;
        	
      	  JOptionPane.showMessageDialog(this, "La prima del empleado es: "+ prima);
